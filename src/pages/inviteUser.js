  ...
  _onInvite () {
    ...
    if (!_SELF.state.channel) {
      sb.GroupChannel.createChannel(this.state.inviteList, false, function (channel, error) {
        ...
        _SELF.props.navigation.navigate('chat', {channel: channel, _onHideChannel: _SELF.props.navigation.state.params._onHideChannel, refresh: _SELF.props.navigation.state.params.refresh})
      })
    } else {
